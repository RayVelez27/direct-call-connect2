      ...
      <div className="w-full max-w-xl space-y-8">
        ...
        <form className="space-y-5" onSubmit={handleSignUp}>
          ...
          <div className="flex items-start gap-2">
            ...
            />
            <Label htmlFor="hero-terms" className="text-sm font-normal text-muted-foreground cursor-pointer leading-relaxed">
              I agree to the{" "}
              <Link to="/terms" className="text-primary hover:underline font-medium">Terms of Service</Link>{" "}
              and{" "}
              <Link to="/trust-and-safety" className="text-primary hover:underline font-medium">Privacy Policy</Link>.
            </Label>
          </div>
